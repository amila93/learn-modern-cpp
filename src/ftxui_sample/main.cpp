...
// configuration step. It creates a namespace called `learn_modern_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", learn_modern_cpp::cmake::project_name, learn_modern_cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", learn_modern_cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
